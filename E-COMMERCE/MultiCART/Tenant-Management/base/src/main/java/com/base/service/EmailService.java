...
public class EmailService {
	...
	public void sendMail(String recipientEmail, String subject, String body, Map<String, File> inlineImages) {
		EmailTask task = new EmailTask(Arrays.asList(recipientEmail), subject, body, inlineImages);
	...
	public void sendMail(List<String> recipientEmail, String subject, String body, Map<String, File> inlineImages) {
		EmailTask task = new EmailTask(recipientEmail, subject, body, inlineImages);
		this.postEmailTask(task);
	}

	public void sendMail(String recipientEmail, String subject, String body, Map<String, File> inlineImages,
			List<File> attachments) {
		EmailTask task = new EmailTask(Arrays.asList(recipientEmail), subject, body, inlineImages, attachments);
		this.postEmailTask(task);
	}

	public void sendMail(String recipientEmail, String cc, String subject, String body, Map<String, File> inlineImages,
			List<File> attachments) {
		EmailTask task = new EmailTask(Arrays.asList(recipientEmail), Arrays.asList(cc), subject, body, inlineImages,
				attachments);
		this.postEmailTask(task);
	}
	...
	public void sendMail(List<String> recipientEmail, String subject, String body, Map<String, File> inlineImages,
			List<File> attachments) {
		EmailTask task = new EmailTask(recipientEmail, subject, body, inlineImages, attachments);
		this.postEmailTask(task);
	}
	...
	public void sendMail(List<String> recipientEmail, List<String> cc, String subject, String body,
		...
		EmailTask task = new EmailTask(recipientEmail, cc, subject, body, inlineImages, attachments);
		this.postEmailTask(task);
	}
