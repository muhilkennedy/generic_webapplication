...
@EnableJpaRepositories(basePackages = { "com.base.repository.*", "com.tenant.repository.*", "com.user.repository.*"})
@EnableR2dbcRepositories(basePackages = { "com.base.reactive.repository.*", "com.tenant.reactive.*", "com.user.reactive.repository.*" })
...
public class TenantManagementApplication {
	...
	public static void main(String[] args) {
		Log.logger.info("<<<<<<<<<<<<< Starting Tenant Managenent Application >>>>>>>>>>>>>");
