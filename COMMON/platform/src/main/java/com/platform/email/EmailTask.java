...
public class EmailTask implements Runnable {
	...
	public EmailTask(List<String> recipientEmail, String subject, String body, Map<String, File> inlineImages) {
	...
	public EmailTask(List<String> recipientEmail,
	...
	public void sendEmail() throws Exception {
		...
		try {
			...
			Log.platform.info("sendEmail :: Email sent Successfully to Recipient - {}", StringUtils.join(recipientEmail, ","));
